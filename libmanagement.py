...
canvas1.create_text( 500,50, text = "WELCOME TO THE LIBRARY MANAGEMENT SYSTEM",fill="black",font=("Arial Black",25))
...
def clicked_on_librariansmenu():
    ...
    l4=tkinter.Label(window4,fg='black',text="\tTHIS IS THE LIBRARIAN'S COUNTER\n\n\n\n",font=("Calibri Bold",30)).pack()
    bt4_1=tkinter.Button(window4,text="\tADD BOOKS\t",height = 3, width = 30,bg="black",fg="white",command=clicked_on_add_books).pack()
    bt4_2=tkinter.Button(window4,text="REMOVE BOOKS\t",height = 3, width = 30,bg="white",fg="black",command=clicked_on_remove_books).pack()
    bt4_3=tkinter.Button(window4,text="\tBOOKS AVAILABLE\t",height = 3, width = 30,bg="black",fg="white",command=clicked_on_available_books).pack()
    bt4_4=tkinter.Button(window4,text="\tCHANGE LOGIN CREDENTIALS\t",height = 3, width = 30,bg="white",fg="black",command=librarians_credentials_change).pack()
    bt4_5=tkinter.Button(window4,text="\tQUIT\t",height = 3, width = 30,bg="black",fg="white",command=clicked_on_quit_window4).pack()
...
def clicked_on_membership():
    ...
    l5=tkinter.Label(window5,fg='black',text='THIS IS THE MEMBERSHIP COUNTER\n\n\n',font=("Calibri Bold",20))
...
bt6=tkinter.Button(window,text="\tDAILY NEWSPAPER\t",height = 2, width = 30,bg="white",fg="black",command=newspaper_driver)
