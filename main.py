...
canvas1.create_text(500, 50, text="WELCOME TO THE LIBRARY MANAGEMENT SYSTEM",
                    fill="black", font=("Arial Black", 25))
...
def newuser_cred_submit():
    ...
    if flag1 == 1:
        messagebox.showinfo(
            'ERROR', 'Try another username this one already exists')
        window1.destroy()
    else:
        file1.write(usr.get()+"\n")
        file1.close()
    ...
    if flag2 == 1:
        messagebox.showinfo(
            'ERROR', 'Try another password this one already exists')
        window1.destroy()
    else:
...
def clicked_on_newuser():
    ...
    l1 = tkinter.Label(window1, fg='orange',
                       text="NEW USER CREDENTIALS\n\n\n", font=("Calibri Bold", 20))
    ...
    sub_button = tkinter.Button(
        window1, text="  SUBMIT  ", bg='blue', fg='white', command=newuser_cred_submit)
...
def login_page_for_issue():
    ...
    l2_1 = tkinter.Label(
        window2_1, fg='red', text='Please login to your account\n\n', font=("Calibri Bold", 15))
    ...
    bt2_1 = tkinter.Button(window2_1, text="LOGIN\t", height=1, width=10,
                           bg="blue", fg="white", command=check_for_login_credentils)
...
def check_for_login_credentils():
    ...
    if flag1 == 1 and flag2 == 1:
        ...
        messagebox.showinfo(
            'ERROR', 'Please input your valid USERNAME and PASSWORD.')
        window2_1.destroy()
    else:
        flag1 = flag2 = 0
#############################################################################################################################
...
def login_page_for_return():
    ...
    login_paswrd.grid(column=1, row=5)
    bt2_1 = tkinter.Button(window2_1, text="LOGIN\t", height=1, width=10,
                           bg="blue", fg="white", command=check_for_login_credentils2)
    bt2_1.grid(column=1, row=7)
...
def clicked_on_bookissue():
    ...
    l2 = tkinter.Label(
        window2, fg='green', text='THIS IS THE BOOK ISSUEING COUNTER\n\n\n', font=("Calibri Bold", 20))
    l2.grid(column=1, row=0)
    bt2_1 = tkinter.Button(window2, text='BOOKS AVAILABLE', height=1,
                           width=15, fg='green', bg='white', command=clicked_on_available_books)
    ...
    bt2_2 = tkinter.Button(window2, text='ISSUE', height=1, width=15,
                           fg='blue', command=clicked_on_bookissue_issuebutton)
...
def clicked_on_bookreturn():
    ...
    l3 = tkinter.Label(
        window3, fg='blue', text='THIS IS THE BOOK RETURNING COUNTER\n\n\n', font=("Calibri Bold", 20))
    ...
    sub_bt = tkinter.Button(window3, text="RETURN\t", height=1, width=10,
                            bg="blue", fg="white", command=clicked_on_bookreturn_return_button)
...
def clicked_on_add_books():
    ...
    l4_1 = tkinter.Label(window4_1, fg='pink',
                         text='ADD BOOKS HERE\n', font=("Calibri Bold", 20))
    ...
    sub_bt = tkinter.Button(window4_1, text="SUBMIT\t", height=1,
                            width=10, bg="yellow", fg="orange", command=submit_book_details)
...
def clicked_on_remove_books():
    ...
    l4_1 = tkinter.Label(window4_2, fg='pink',
                         text='REMOVE BOOKS \n', font=("Calibri Bold", 20))
    l4_1.grid(column=1, row=0)
    ...
    sub_bt = tkinter.Button(window4_2, text="REMOVE\t", height=1,
                            width=10, bg="yellow", fg="orange", command=remove_book_details)
...
def librarians_login_details():
    ...
    l4_3 = tkinter.Label(
        window4_3, fg='red', text="Please login to LIBRARIAN'S account\n\n", font=("Calibri Bold", 15))
    ...
    bt4_3 = tkinter.Button(window4_3, text="LOGIN\t", height=1, width=10,
                           bg="blue", fg="white", command=check_librarians_login_details)
...
def librarians_credentials_change():
    ...
    l4_4 = tkinter.Label(
        window4_4, fg='red', text='Change login details here\n\n', font=("Calibri Bold", 15))
    l4_4.grid(column=0, row=1)
    login_cred1 = tkinter.Label(
        window4_4, text="\t\t\tEnter your new USERNAME\n")
    login_cred1.grid(column=0, row=3)
    login_librarian_usr_chng = tkinter.Entry(window4_4, width=15)
    login_librarian_usr_chng.grid(column=1, row=3)
    login_cred2 = tkinter.Label(
        window4_4, text="\t\t\tEnter your new PASSWORD\n")
    login_cred2.grid(column=0, row=5)
    login_librarian_paswrd_chng = tkinter.Entry(window4_4, width=15)
    login_librarian_paswrd_chng.grid(column=1, row=5)
    bt4_3 = tkinter.Button(window4_4, text="CHANGE\t", height=1, width=10,
                           bg="blue", fg="white", command=check_librarians_credentials_change)
    bt4_3.grid(column=1, row=7)
...
def clicked_on_librariansmenu():
    ...
    l4 = tkinter.Label(window4, fg='black', text="\tTHIS IS THE LIBRARIAN'S COUNTER\n\n\n\n", font=(
        "Calibri Bold", 30)).pack()
    bt4_1 = tkinter.Button(window4, text="\tADD BOOKS\t", height=3, width=30,
                           bg="black", fg="white", command=clicked_on_add_books).pack()
    bt4_2 = tkinter.Button(window4, text="REMOVE BOOKS\t", height=3, width=30,
                           bg="white", fg="black", command=clicked_on_remove_books).pack()
    bt4_3 = tkinter.Button(window4, text="\tBOOKS AVAILABLE\t", height=3, width=30,
                           bg="black", fg="white", command=clicked_on_available_books).pack()
    bt4_4 = tkinter.Button(window4, text="\tCHANGE LOGIN CREDENTIALS\t", height=3,
                           width=30, bg="white", fg="black", command=librarians_credentials_change).pack()
    bt4_5 = tkinter.Button(window4, text="\tQUIT\t", height=3, width=30,
                           bg="black", fg="white", command=clicked_on_quit_window4).pack()
...
def clicked_on_membership():
    ...
    l5 = tkinter.Label(
        window5, fg='black', text='THIS IS THE MEMBERSHIP COUNTER\n\n\n', font=("Calibri Bold", 20))
...
def newspaper_driver():
    news.mainNewscode()

##############################################################################################################################


bt1 = tkinter.Button(window, text="\tNEW USER\t", height=2,
                     width=30, bg="black", fg="white", command=clicked_on_newuser)
button1_canvas = canvas1.create_window(520, 200, anchor="center", window=bt1)
bt2 = tkinter.Button(window, text="\tBOOK ISSUE\t", height=2,
                     width=30, bg="white", fg="black", command=login_page_for_issue)
button2_canvas = canvas1.create_window(520, 250, anchor="center", window=bt2)
bt3 = tkinter.Button(window, text="\tBOOK RETURN\t", height=2,
                     width=30, bg="black", fg="white", command=login_page_for_return)
button3_canvas = canvas1.create_window(520, 300, anchor="center", window=bt3)
bt4 = tkinter.Button(window, text="\tLIBRARIAN'S MENU\t", height=2,
                     width=30, bg="white", fg="black", command=librarians_login_details)
button4_canvas = canvas1.create_window(520, 350, anchor="center", window=bt4)
bt5 = tkinter.Button(window, text="\tMEMBERSHIPS\t", height=2,
                     width=30, bg="black", fg="white", command=clicked_on_membership)
button5_canvas = canvas1.create_window(520, 400, anchor="center", window=bt5)
bt6 = tkinter.Button(window, text="\tDAILY NEWSPAPER\t", height=2,
                     width=30, bg="white", fg="black", command=newspaper_driver)
button6_canvas = canvas1.create_window(520, 450, anchor="center", window=bt6)
bt7 = tkinter.Button(window, text="\tQUIT\t", height=2, width=30,
                     bg="black", fg="white", command=clicked_on_quit_window)
